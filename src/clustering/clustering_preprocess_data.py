...
#for EXP in [Experiments.ERA5]:
    ...
    #for season_ in [Season.DJF]:
        ...
        cdo.sub(input= f"{out_string}_fldmean_detrend.nc {exp.control_aac_file}{season.name}_fldmean_detrend_ydaymean.nc",
        ...
        cdo.sub(input= f"  {out_string}_fldmean_detrend_del29feb.nc {exp.control_aac_file_del29feb}{season.name}_fldmean_detrend_ydaymean_del29feb.nc",
