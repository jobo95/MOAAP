...
class CNRM_EXPERIMENT:
    ...
    control_aac_file_del29feb: str = (
        "/work/aa0238/a271093/data/clustering/CNRM_control/CNRM_ICON_control_gph70000_1984_2014_reglonlat_-90_90_20_88_1deg_"
    )
    control_aac_file: str = (
        "/work/aa0238/a271093/data/clustering/CNRM_control/CNRM_ICON_control_gph70000_1984_2014_reglonlat_-90_90_20_88_1deg_"
    )
...
class NorESM_EXPERIMENT:
    ...
    control_aac_file_del29feb: str = (
        "/work/aa0238/a271093/data/clustering/NorESM_control/NORESM_ICON_control_gph70000_1984_2014_reglonlat_-90_90_20_88_1deg_"
    )
    control_aac_file: str = (
        "/work/aa0238/a271093/data/clustering/NorESM_control/NORESM_ICON_control_gph70000_1984_2014_reglonlat_-90_90_20_88_1deg_"
    )
...
class ICON_NorESM_CONTROL(ICONExperiment, CONTROL_EXPERIMENT, NorESM_EXPERIMENT):
    ...
    BMU_file: str = (
        "NORESM_ICON_control_gph70000_1984_2014_reglonlat_-90_90_20_88_1deg_DJF_fldmean_detrend_del29feb_aac_20PCs_4clusters_Ref_ERA5KmeansPCA.csv"
    )
...
class ICON_CNRM_CONTROL(ICONExperiment, CONTROL_EXPERIMENT, CNRM_EXPERIMENT):
    ...
    path: str = (
        "/work/aa0238/a271093/data/Jan_runs/ICON_CNRM_control/CNRM_control_remapped_3x/"
    )
    ...
    path_raw: str = (
        "/work/aa0049/a271109/spice-v2.1/chain/work/polarres_wp3_cmip_CNRM/post/yearly/"
    )
    ...
    BMU_file: str = (
        "CNRM_ICON_control_gph70000_1984_2014_reglonlat_-90_90_20_88_1deg_DJF_fldmean_detrend_del29feb_aac_20PCs_4clusters_Ref_ERA5KmeansPCA.csv"
    )
...
class ICON_NorESM_SSP(ICONExperiment, NorESM_EXPERIMENT, SSP_EXPERIMENT):
    ...
    path_raw_gcm: str = (
        "/pool/data/CMIP6/data/ScenarioMIP/NCC/NorESM2-MM/ssp370/r1i1p1f1/day/"
    )
    gph_path_raw_gcm: str = f"{path_raw_gcm}zg/gn/v20191108/"
...
class ICON_CNRM_SSP(ICONExperiment, CNRM_EXPERIMENT, SSP_EXPERIMENT):
    ...
    path_IVT: str = (
        "/work/aa0238/a271093/data/Jan_runs/ICON_CNRM_ssp/CNRM_ssp_remapped_3x/"
    )
    path_raw: str = (
        "/work/aa0049/a271109/spice-v2.2/chain/work/polarres_wp3_cmip_CNRM_ssp370/post/yearly/"
    )
    path_raw_gcm: str = (
        "/pool/data/CMIP6/data/ScenarioMIP/CNRM-CERFACS/CNRM-ESM2-1/ssp370/r1i1p1f2/day/"
    )
    ...
    IVTobj_out_path: str = (
        "/work/aa0238/a271093/results/MOAAP/IVT_Tracking/CNRM_ssp_remapped_3x/"
    )
    IVT_thresh_file_85: str = "IVT_85_percentiles_CNMR_ssp_3dx3dy.nc"

    BMU_file: str = (
        "CNRM_ICON_SSP_gph70000_2015_2100_reglonlat_-90_90_20_88_1deg_DJF_fldmean_detrend_del29feb_aac_20PCs_4clusters_Ref_ERA5KmeansPCA.csv"
    )
...
class ERA5(ICONExperiment):
    ...
    gph_path_raw_gcm: str = (
        "/work/bm1159/XCES/data4xces/reanalysis/reanalysis/ECMWF/IFS/ERA5/day/atmos/zg/r1i1p1-070000Pa/"
    )
    gph_files_raw_gcm: Tuple[str] = tuple(sorted(glob.glob(gph_path_raw_gcm + "*")))
